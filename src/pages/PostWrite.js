...
const PostWrite = (props) => {
  ...
  const addPost = () => {
    if (preview === null || contents === "" || layout === "") {
      window.alert(
        "이미지 업로드와 레이아웃 선택, 게시글 작성을 모두 완료해주세요!"
      );
      return;
    } else {
    ...
    <React.Fragment>
      <Grid margin="80px 0 0 0">
        ...
        <Grid margin="16px" width="auto">
          ...
          ></Input>
          <Grid is_flex margin="20px 0" border="0.5px dashed #333">
            <Image
              shape="rectangle"
              margin="40px 0"
              size="16"
        ...
        <Grid margin="16px" width="auto">
          <Input
            ...
            _onClick={handleLayout}
          ></Input>
					<Grid margin="20px 0" border="0.5px dashed #333">
					<Image
            shape="rectangle"
            margin="40px auto"
            src={preview ? preview : Album}
